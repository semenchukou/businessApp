...
<h3 align="center" style="font-size:40px;">Add club</h3>
...
<form action="${pageContext.request.contextPath}/?command=add" method="post">
    <table border="0" cellspacing="5" cellpadding="10" align="center">
        <tr>
            <td>Name:</td>
            <td><input type="text" name="name" style="font-size:20px;"/><input type="hidden" name="dict" value="clubs"></td>
        </tr>
        <tr>
            <td>Coach:</td>
            <td><input type="text" name="coach" style="font-size:20px;"/></td>
        </tr>
        <tr>
            <td>Foundation year:</td>
            <td><input type="number" min="1000" step="1" max="2020" name="year" style="font-size:20px;"/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
